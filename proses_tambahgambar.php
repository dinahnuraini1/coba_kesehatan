...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['gambar']['name'] != "") {
        ...
        if ($_FILES["gambar"]["size"] > 10000000) {
            $response['error'] = true;
            $response['message'] = "Maaf, ukuran gambar terlalu besar. Maksimum 10MB.";
        } else {
            ...
            if ($check !== false) {
                ...
                if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif") {
                    ...
                    if (move_uploaded_file($sumber_gambar, $folder . $nama_gambar)) {
                        ...
                        $sql = "INSERT INTO tb_gambar (gambar, nama_kegiatan, tanggal) VALUES ('$nama_gambar', '$nama_kegiatan', '$tanggal')";
